  ...
  return (
    <PageShell>
      <main className="mx-auto min-h-screen max-w-7xl px-4 pb-20 pt-32 sm:px-6 lg:px-10">
        ...
        <p className="mt-5 max-w-2xl leading-7 text-nord-smoke">MVP использует Steam login mock: кнопка создает локальную тестовую сессию и открывает профиль.</p>
        <div className="mt-10 grid gap-4 sm:grid-cols-2">
          ...
          <div className="border border-nord-border bg-nord-card/80 p-8 text-nord-smoke shadow-survival backdrop-blur-md">
            Discord OAuth подключается после MVP.
          </div>
        </div>
      </main>
    </PageShell>
